...
image_features = extract_features_batch(image_path, base_model, img_size=224, batch_size=32)

# Convert features to a Pandas DataFrame for analysis
features_df = pd.DataFrame.from_dict(image_features, orient='index')
features_df.reset_index(inplace=True)
features_df.columns = ['image'] + [f'feature_{i}' for i in range(features_df.shape[1] - 1)]
```